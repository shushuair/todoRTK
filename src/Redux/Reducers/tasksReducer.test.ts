import {tasksActions, tasksReducer, TasksStateReducerType, tasksThunks} from "Redux/Reducers/tasksReducer";
import {todolistsActions} from "Redux/Reducers/todolistReducer";
import {TaskPriorities, TaskStatuses, TasksType} from "api/typeApi";

let startState: TasksStateReducerType = {};
beforeEach(() => {
    startState = {
        todolistId1: [
            {
...
test("status of specified task should be changed", () => {
    // const payload = { taskId: "2", domainModel: { status: TaskStatuses.New  }, todolistId: "todolistId2" }
    //
...
test("tasks should be added for todolist", () => {
    ...
    type Action = {
        type: string,
        payload: {tasks: TasksType[], todolistId: string}
    }
    const action: Action = {
