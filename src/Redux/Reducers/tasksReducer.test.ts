import {TasksStateReducerType} from "Redux/Reducers/tasksReducer";
import {TaskPriorities, TaskStatuses} from "api/typeApi";
...
//     // const action = todolistThunk.getTodolist({
//     //     todolists: [
